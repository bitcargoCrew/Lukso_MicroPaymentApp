...
export function TokenSymbol(props) {
    if (!isNativeToken(props.token)) {
        return (_jsx(Text, { size: props.size, color: "primaryText", children: props.token.symbol }));
    }
    return _jsx(NativeTokenSymbol, { chain: props.chain, size: props.size });
}
function NativeTokenSymbol(props) {
    ...
    return (_jsx(Text, { size: props.size, color: "primaryText", children: data.nativeCurrency.symbol }));
}

...
export function WalletLogoSpinner(props) {
    ...
    return (_jsx(LogoContainer, { "data-error": props.error, children: _jsx("div", { "data-container": true, style: {
                ...
                alignItems: "center",
                        ...
                        }, role: "presentation", children: _jsx("rect", { x: "2", y: "2", width: "106", height: "106", rx: loaderRadius, strokeDasharray: `${dashArrayStart} ${dashArrayEnd}`, strokeDashoffset: dashOffset, strokeLinecap: "round", fill: "none", strokeWidth: 4 }) }), _jsx(WalletBg, { children: _jsx(WalletImage, { id: props.id, size: "68" }) })] }) }) }));
}
